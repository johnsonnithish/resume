...
export default function Projects() {
  const cards=[
    <div style={{textAlign: 'center'}}>
      ...
      <img src="../src/assets/imgs/GameBoxd_log.png" />
      ...
      <div className="image-grid">
        <img src="../src/assets/imgs/gb_1.png"  />
        <img src="../src/assets/imgs/gb_2.png"  />
        <img src="../src/assets/imgs/gb_3.png"  />
        <img src="../src/assets/imgs/gb_4.png"  />
      </div>
    </div>,
    <div style={{textAlign: 'center'}}>
      ...
      >
        <img
          src="../src/assets/imgs/rasa_logo.png"
          alt="Rasa"
      ...
      <div className="image-grid">
        <img src="../src/assets/imgs/rasa_1.png"  />
        <img src="../src/assets/imgs/rasa_2.png"  />
        <img src="../src/assets/imgs/rasa_3.png"  />
        <img src="../src/assets/imgs/rasa_4.png"  />
      </div>
    </div>,
    <div style={{textAlign: 'center'}}>
      ...
      >
        <img
          src="../src/assets/imgs/Solar-Panel.png"
          alt="Rasa"
          style={{ maxWidth: '100%', maxHeight: '100%', display: 'block' }}
        />
      </div><br /><br /><br /><br /><br />
      ...
      <div className="image-grid image-grid--crop">
        <img src="../src/assets/imgs/solar_1.jpg" />
        <img src="../src/assets/imgs/solar_2.jpg" />
        <img src="../src/assets/imgs/solar_3.jpg" />
        <img src="../src/assets/imgs/solar_4.jpg" />
      </div>
    </div>,
    <div style={{
      display: 'flex',
