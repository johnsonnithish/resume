    ...
    <div style={{textAlign: 'center'}}>
      ...
      <div
        style={{
          ...
          height: 250,
          margin: '0 auto',
          backgroundImage: "url('../src/assets/imgs/Udemy_1.png')",
    ...
    <div style={{textAlign: 'center'}}>
      ...
      <div
        style={{
          ...
          height: 250,
          margin: '0 auto',
          backgroundImage: "url('../src/assets/imgs/Udemy_2.png')",
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
        }}
    ...
    <div style={{textAlign: 'center'}}>
      ...
      <div
        style={{
          ...
          height: 250,
          margin: '0 auto',
          backgroundImage: "url('../src/assets/imgs/AI-Powered_ChatBots_Workshop.jpg')",
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
        }}
    ...
    <div style={{textAlign: 'center'}}>
      ...
      <div
        style={{
          ...
          height: 250,
          margin: '0 auto',
          backgroundImage: "url('../src/assets/imgs/Data Analytics with Python.jpg')",
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
        }}
    ...
    <div style={{textAlign: 'center'}}>
      ...
      <div
        style={{
          ...
          height: 250,
          margin: '0 auto',
          backgroundImage: "url('../src/assets/imgs/The Joy of Computing using Python.jpg')",
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
        }}
